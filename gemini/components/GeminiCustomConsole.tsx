      ...
      >
        ...
        >
          <div className="agent-icon">
            <span className="material-symbols-outlined filled" style={{ color: '#ffffff' }}>
              {agentName.toLowerCase().includes('cooking') ? 'restaurant' : 
               agentName.toLowerCase().includes('alchemy') ? 'science' : 
               agentName.toLowerCase().includes('judge') ? 'gavel' : 'smart_toy'}
            </span>
          </div>
        ...
        {showInput && (
          ...
          >
            <div className="input-wrapper" style={{ display: 'flex', gap: '12px', alignItems: 'flex-end' }}>
              <textarea
